...
name_file = open("D:\Python\Projects\VA\Assistant_name.txt", "r")
...
def get_audio(): 
    ...
    with sr.Microphone() as source: 
        ...
        print("Listening") 
        playsound(r"VA/assistant_on.wav")
        audio = r.listen(source, phrase_time_limit = 3) 
        playsound(r"VA/assistant_off.wav")
        print("Stop.") 
    ...
    if __name__=='__main__':
        while run==1:
            ...
            if statement == "none":
                ...
                continue  # Ask again without proceeding to other commands
...
def change_name():
  ...
  file=open("D:\Python\Projects\VA\Assistant_name.txt", "w")
...
def change_name_window():
      ...
      settings_screen.iconbitmap(r"VA\app_icon.ico")
...
def info():
  ...
  info_screen.iconbitmap(r"VA\app_icon.ico")
...
def wikipedia_screen(text):
  ...
  wikipedia_screen.iconbitmap(r"VA\app_icon.ico")
...
def main_screen():
      ...
      screen.iconbitmap(r"VA\app_icon.ico")
      ...
      microphone_photo = PhotoImage(file = r"VA/assistant_logo.png")
      microphone_button = Button(image=microphone_photo, command = Process_audio)
      microphone_button.pack(pady=10)

      settings_photo = PhotoImage(file = r"VA/settings.png")
